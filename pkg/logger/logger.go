...
func (l *Logger) LogSuccess(m LogModel) {
	...
	if m.Database != nil {
		err := m.Database.AddLogEntry(m.GuildID, model.SuccessType, m.Function, m.Message)
		if err != nil {
...
func (l *Logger) LogInfo(m LogModel) {
	...
	if m.Database != nil {
		err := m.Database.AddLogEntry(m.GuildID, model.InfoType, m.Function, m.Message)
		if err != nil {
...
func (l *Logger) LogWarning(m LogModel) {
	...
	if m.Database != nil {
		err := m.Database.AddLogEntry(m.GuildID, model.WarningType, m.Function, m.Message)
		if err != nil {
...
func (l *Logger) LogError(m LogModel) {
	...
	if m.Database != nil {
		err := m.Database.AddLogEntry(m.GuildID, model.ErrorType, m.Function, m.Message)
		if err != nil {
